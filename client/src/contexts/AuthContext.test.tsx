...
describe('AuthContext', () => {
  ...
  it('loads user from stored token on mount', async () => {
    const mockToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..test'
  ...
  it('logs in user successfully', async () => {
    ...
    expect(apiClient.apiClient.setToken).toHaveBeenCalledWith(mockAuthResponse.accessToken)
  })
  ...
  it('correctly identifies moderator role', async () => {
    const moderatorToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..test'
